...
Make sure your computer is running one of these systems. If you are unsure, you can usually find your system information in your computer’s settings.

---

## 💾 Download & Install franken_numpy
...
- **Windows:** Double-click the `.exe` file to start installation. Follow on-screen prompts to complete setup.
- **macOS:** Double-click the `.dmg` file. Drag the franken_numpy app to your Applications folder.
- **Linux:** If you have an `.AppImage`, you may need to make it executable.
...
- On Linux, look in your applications menu or open a terminal and type `franken_numpy` if it added itself to your system path.
...
- **Installer won’t start:** Make sure you downloaded the correct file for your system.
